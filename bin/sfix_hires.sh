...
BEST_RESOLUTION=$(xrandr | grep -A4 "^${EXTERNAL_MONITOR} " | grep -v connected | awk '{print $1}' | grep -E '(3840x2160|3840x1200|2560x1440|2560x1600|1920x1080|1920x1200)' | head -1)
